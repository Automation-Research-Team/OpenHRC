...
3. Start ohrc_teleoperation
```bash
ros2 launch ohrc_teleoperation marker_teleoperation.launch.py robot:=xarm6
```
...
#### 3. Start ohrc_teleoperation
```bash
ros2 launch ohrc_teleoperation marker_teleoperation.launch.py robot:=gen3lite
```
...
#### 3. Start ohrc_teleoperation
```bash
ros2 launch ohrc_teleoperation marker_teleoperation.launch.py robot:=iiwa14
```
...
#### 3. Start ohrc_teleoperation
```bash
ros2 launch ohrc_teleoperation marker_teleoperation.launch.py robot:=so101
```
