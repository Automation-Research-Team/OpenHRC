...
def generate_launch_description():
  return LaunchDescription([
    ...
    DeclareLaunchArgument('app_dir', default_value=['ohrc_', LaunchConfiguration('app')]),
    ...
    DeclareLaunchArgument('rviz_config', default_value=[LaunchConfiguration('app_dir'), '/config/teleoperation.rviz']),
