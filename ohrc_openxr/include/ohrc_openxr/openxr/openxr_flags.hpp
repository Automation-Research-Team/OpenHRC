 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPassthroughCapabilityFlagBitsFB>
...
enum class PassthroughCapabilityFlagBitsFB : XrFlags64 {
  ...
  AllBits = XR_PASSTHROUGH_CAPABILITY_BIT_FB | XR_PASSTHROUGH_CAPABILITY_COLOR_BIT_FB |
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPassthroughCapabilityFlagsFB>
 * @xrentity{XrPassthroughCapabilityFlagBitsFB}
 * @see PassthroughCapabilityFlagBitsFB, xr::Flags
 */
using PassthroughCapabilityFlagsFB =
    Flags<PassthroughCapabilityFlagBitsFB, XrPassthroughCapabilityFlagsFB>;
 ...
 */
OPENXR_HPP_INLINE PassthroughCapabilityFlagsFB operator|(PassthroughCapabilityFlagBitsFB bit0,
                                                         PassthroughCapabilityFlagBitsFB bit1) {
...
enum class PassthroughFlagBitsFB : XrFlags64 {
  ...
  AllBits = XR_PASSTHROUGH_IS_RUNNING_AT_CREATION_BIT_FB | XR_PASSTHROUGH_LAYER_DEPTH_BIT_FB
};
...
enum class RenderModelFlagBitsFB : XrFlags64 {
  ...
  AllBits = XR_RENDER_MODEL_SUPPORTS_GLTF_2_0_SUBSET_1_BIT_FB |
...
enum class CompositionLayerSpaceWarpInfoFlagBitsFB : XrFlags64 {
  ...
  AllBits = XR_COMPOSITION_LAYER_SPACE_WARP_INFO_FRAME_SKIP_BIT_FB
};
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrCompositionLayerSettingsFlagBitsFB>
...
enum class CompositionLayerSettingsFlagBitsFB : XrFlags64 {
  ...
  AllBits = XR_COMPOSITION_LAYER_SETTINGS_NORMAL_SUPER_SAMPLING_BIT_FB |
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrCompositionLayerSettingsFlagsFB>
 * @xrentity{XrCompositionLayerSettingsFlagBitsFB}
 * @see CompositionLayerSettingsFlagBitsFB, xr::Flags
 */
using CompositionLayerSettingsFlagsFB =
    Flags<CompositionLayerSettingsFlagBitsFB, XrCompositionLayerSettingsFlagsFB>;
 ...
 */
OPENXR_HPP_INLINE CompositionLayerSettingsFlagsFB
operator|(CompositionLayerSettingsFlagBitsFB bit0, CompositionLayerSettingsFlagBitsFB bit1) {
 ...
 */
OPENXR_HPP_INLINE CompositionLayerSettingsFlagsFB
operator~(CompositionLayerSettingsFlagBitsFB bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrPerformanceMetricsCounterFlagBitsMETA>
...
enum class PerformanceMetricsCounterFlagBitsMETA : XrFlags64 {
  ...
  AllBits = XR_PERFORMANCE_METRICS_COUNTER_ANY_VALUE_VALID_BIT_META |
 ...
 */
using PerformanceMetricsCounterFlagsMETA =
    Flags<PerformanceMetricsCounterFlagBitsMETA, XrPerformanceMetricsCounterFlagsMETA>;
 ...
 */
OPENXR_HPP_INLINE PerformanceMetricsCounterFlagsMETA
operator|(PerformanceMetricsCounterFlagBitsMETA bit0, PerformanceMetricsCounterFlagBitsMETA bit1) {
 ...
 */
OPENXR_HPP_INLINE PerformanceMetricsCounterFlagsMETA
operator~(PerformanceMetricsCounterFlagBitsMETA bits) {
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFoveationDynamicFlagBitsHTC>
...
enum class FoveationDynamicFlagBitsHTC : XrFlags64 {
  ...
  AllBits = XR_FOVEATION_DYNAMIC_LEVEL_ENABLED_BIT_HTC |
 ...
 *
 * @see
 * <https://www.khronos.org/registry/OpenXR/specs/1.0/html/xrspec.html#XrFoveationDynamicFlagsHTC>
 * @xrentity{XrFoveationDynamicFlagBitsHTC}
 ...
 */
OPENXR_HPP_INLINE FoveationDynamicFlagsHTC operator|(FoveationDynamicFlagBitsHTC bit0,
                                                     FoveationDynamicFlagBitsHTC bit1) {
