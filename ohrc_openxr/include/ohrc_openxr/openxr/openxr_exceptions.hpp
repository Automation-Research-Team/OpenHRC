...
#undef noexcept
  ...
  //! @brief Exception class for the Result::ErrorSpaceComponentNotSupportedFB aka
  //! XR_ERROR_SPACE_COMPONENT_NOT_SUPPORTED_FB result code.
...
#ifdef XR_FB_spatial_entity
  //! @brief Exception class for the Result::ErrorSpaceComponentNotEnabledFB aka
  //! XR_ERROR_SPACE_COMPONENT_NOT_ENABLED_FB result code.
...
#endif  // XR_FB_spatial_entity
#ifdef XR_FB_spatial_entity
  //! @brief Exception class for the Result::ErrorSpaceComponentStatusPendingFB aka
  //! XR_ERROR_SPACE_COMPONENT_STATUS_PENDING_FB result code.
...
#endif  // XR_FB_spatial_entity
#ifdef XR_FB_spatial_entity
  //! @brief Exception class for the Result::ErrorSpaceComponentStatusAlreadySetFB aka
  //! XR_ERROR_SPACE_COMPONENT_STATUS_ALREADY_SET_FB result code.
  ...
  public:
    SpaceComponentStatusAlreadySetErrorFB(std::string const& message)
        : SystemError(impl::make_error_code(Result::ErrorSpaceComponentStatusAlreadySetFB),
                      message) {}
