...
public:
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  Result querySpacesFB(const XrSpaceQueryInfoBaseHeaderFB* info, AsyncRequestIdFB requestId,
                       Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  ResultValue<AsyncRequestIdFB> querySpacesFB(const XrSpaceQueryInfoBaseHeaderFB* info,
                                              Dispatch&& d
                                                  OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  AsyncRequestIdFB querySpacesFB(const XrSpaceQueryInfoBaseHeaderFB* info,
                                 Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  SemanticLabelsFB getSpaceSemanticLabelsFB(Space space,
                                            Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  Boundary2DFB getSpaceBoundary2DFB(Space space,
                                    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  RoomLayoutFB getSpaceRoomLayoutFB(Space space,
                                    Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  SpaceContainerFB getSpaceContainerFB(Space space,
                                       Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
...
public:
  ...
  template <typename Dispatch OPENXR_HPP_DEFAULT_EXT_DISPATCH_TYPE_ARG,
            OPENXR_HPP_REQUIRE_DISPATCH(Dispatch) = 0>
  Result getSpaceUuidFB(UuidEXT& uuid, Dispatch&& d OPENXR_HPP_DEFAULT_EXT_DISPATCH_ARG) const;
