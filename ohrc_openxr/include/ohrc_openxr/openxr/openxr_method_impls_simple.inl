...
OPENXR_HPP_INLINE Result Session::createSpatialAnchorFB(const SpatialAnchorCreateInfoFB& info,
                                                        ...
                                                        Dispatch&& d) const {
  Result result =
      static_cast<Result>(d.xrCreateSpatialAnchorFB(this->get(), info.get(), requestId.get()));
...
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE Result Space::getSpaceUuidFB(UuidEXT& uuid, Dispatch&& d) const {
...
OPENXR_HPP_INLINE Result Space::enumerateSpaceSupportedComponentsFB(
    ...
    XrSpaceComponentTypeFB* componentTypes, Dispatch&& d) const {
  Result result = static_cast<Result>(d.xrEnumerateSpaceSupportedComponentsFB(
      this->get(), componentTypeCapacityInput, componentTypeCountOutput, componentTypes));
...
OPENXR_HPP_INLINE Result Space::setSpaceComponentStatusFB(const SpaceComponentStatusSetInfoFB& info,
                                                          ...
                                                          Dispatch&& d) const {
  Result result =
      static_cast<Result>(d.xrSetSpaceComponentStatusFB(this->get(), info.get(), requestId.get()));
...
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE Result Session::querySpacesFB(const XrSpaceQueryInfoBaseHeaderFB* info,
...
OPENXR_HPP_INLINE Result Session::retrieveSpaceQueryResultsFB(AsyncRequestIdFB requestId,
                                                              ...
                                                              Dispatch&& d) const {
  Result result = static_cast<Result>(
      d.xrRetrieveSpaceQueryResultsFB(this->get(), requestId.get(), results.put()));
...
OPENXR_HPP_INLINE Result Session::getSpaceSemanticLabelsFB(Space space,
                                                           ...
                                                           Dispatch&& d) const {
  Result result = static_cast<Result>(
      d.xrGetSpaceSemanticLabelsFB(this->get(), space.get(), semanticLabelsOutput.put()));
...
OPENXR_HPP_INLINE Result Session::getSpaceBoundary2DFB(Space space, Boundary2DFB& boundary2DOutput,
                                                       Dispatch&& d) const {
  Result result = static_cast<Result>(
      d.xrGetSpaceBoundary2DFB(this->get(), space.get(), boundary2DOutput.put()));
...
OPENXR_HPP_INLINE Result Session::getSpaceRoomLayoutFB(Space space, RoomLayoutFB& roomLayoutOutput,
                                                       Dispatch&& d) const {
  Result result = static_cast<Result>(
      d.xrGetSpaceRoomLayoutFB(this->get(), space.get(), roomLayoutOutput.put()));
...
OPENXR_HPP_INLINE Result Session::getSpaceContainerFB(Space space,
                                                      ...
                                                      Dispatch&& d) const {
  Result result = static_cast<Result>(
      d.xrGetSpaceContainerFB(this->get(), space.get(), spaceContainerOutput.put()));
...
OPENXR_HPP_INLINE Result Instance::enumeratePerformanceMetricsCounterPathsMETA(
  ...
  Result result = static_cast<Result>(d.xrEnumeratePerformanceMetricsCounterPathsMETA(
      this->get(), counterPathCapacityInput, counterPathCountOutput, counterPaths.get()));
