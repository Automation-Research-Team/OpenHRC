...
public:
  ...
  OPENXR_HPP_CONSTEXPR XrAsyncRequestIdFB get() const noexcept { return val_; }
  /*!
   * @brief Returns the address of the raw XrAsyncRequestIdFB value,
   * for use in creation/assignment.
   */
  XrAsyncRequestIdFB *put() noexcept { return &val_; }
  //! @}
...
static_assert(sizeof(XrAsyncRequestIdFB) == sizeof(AsyncRequestIdFB),
              "Original type and wrapper have different size!");
 ...
 * @ingroup utility_accessors
 */
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE XrAsyncRequestIdFB get(AsyncRequestIdFB v) noexcept {
  return v.get();
}
/*!
 * @brief Free function for getting the address of the raw XrAsyncRequestIdFB from an
 * AsyncRequestIdFB value.
 *
 * @found_by_adl
...
//! @relates AsyncRequestIdFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(AsyncRequestIdFB lhs,
                                                       AsyncRequestIdFB rhs) noexcept {
  return lhs.get() == rhs.get();
}
//! @brief `!=` comparison between AsyncRequestIdFB values.
//! @relates AsyncRequestIdFB
...
//! @relates AsyncRequestIdFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(AsyncRequestIdFB lhs,
                                                       XrAsyncRequestIdFB rhs) noexcept {
  return lhs.get() == rhs;
}
//! @brief `==` comparison between raw XrAsyncRequestIdFB and AsyncRequestIdFB.
//! @relates AsyncRequestIdFB
OPENXR_HPP_CONSTEXPR OPENXR_HPP_INLINE bool operator==(XrAsyncRequestIdFB lhs,
                                                       AsyncRequestIdFB rhs) noexcept {
  return lhs == rhs.get();
}
//! @brief `!=` comparison between AsyncRequestIdFB and raw XrAsyncRequestIdFB.
