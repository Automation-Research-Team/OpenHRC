...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<Boundary2DFB> Session::getSpaceBoundary2DFB(Space space,
                                                                          Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<RoomLayoutFB> Session::getSpaceRoomLayoutFB(Space space,
                                                                          Dispatch&& d) const {
...
#ifdef OPENXR_HPP_NO_EXCEPTIONS
template <typename Dispatch, OPENXR_HPP_REQUIRE_DISPATCH(Dispatch)>
OPENXR_HPP_INLINE ResultValue<SpaceContainerFB> Session::getSpaceContainerFB(Space space,
                                                                             Dispatch&& d) const {
